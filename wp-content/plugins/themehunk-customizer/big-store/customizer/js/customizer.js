...
jQuery('#_customize-input-big_store_above_header_col1_set option[value="none"],#_customize-input-big_store_above_header_col1_set option[value="menu"],#_customize-input-big_store_above_header_col1_set option[value="widget"],#_customize-input-big_store_above_header_col2_set option[value="none"],#_customize-input-big_store_above_header_col2_set option[value="social"],#_customize-input-big_store_above_header_col2_set option[value="menu"],#_customize-input-big_store_above_header_col2_set option[value="widget"]').attr("disabled",true);
...
jQuery('#customize-control-big_store_category_slide_list li input').attr("disabled",true);
jQuery('#customize-control-big_store_category_slide_list li:nth-of-type(1) input,#customize-control-big_store_category_slide_list li:nth-of-type(2) input,#customize-control-big_store_category_slide_list li:nth-of-type(3) input,#customize-control-big_store_category_slide_list li:nth-of-type(4) input').attr("disabled",false);
...
jQuery('#customize-control-big_store_single_row_prdct_slide input,#customize-control-big_store_product_slider_optn input,#_customize-input-big_store_product_slider_cat option,#_customize-input-big_store_product_list_cat option').attr("disabled",true);
jQuery('#_customize-input-big_store_product_slider_cat option:nth-of-type(1),#_customize-input-big_store_product_list_cat option:nth-of-type(1)').attr("disabled",false);
//Banner
...
jQuery('#customize-control-big_store_category_slide_list,#customize-control-big_store_product_slider_cat').append("<h4>(To Select More Feature Available In Pro Version)</h4>");


// Big Store Theme limitaions
jQuery('#customize-control-big_store_above_header_layout,#customize-control-big_store_above_footer_layout').addClass("lite");       
    jQuery('input[id=big_store_above_header_layout-abv-none],input[id=big_store_above_header_layout-abv-one],input[id=big_store_above_header_layout-abv-three],input[id=big_store_top_slide_layout-slide-layout-5]').attr("disabled",true);

    //Disable select option
    jQuery('#_customize-input-big_store_blog_post_content option[value="full"],#_customize-input-big_store_blog_post_content option[value="nocontent"]').attr("disabled", true);
    //Disable select input, toggle
    jQuery('#customize-control-big_store_blog_read_more_txt input,#customize-control-big_store_rtl input,#customize-control-big_store_exclde_category input').attr("disabled", true);

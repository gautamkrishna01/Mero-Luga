 ...
 <div class="recentpost_mystyle">
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>        
        ...
        <div class="entry-summary">
           	<?php the_excerpt(); ?>
            <a class="blogpostmorebtn" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more &rarr;','flourish-lite'); ?></a>         
        </div><!-- .entry-summary -->
        <?php else : ?>
        <div class="entry-content">
            <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'flourish-lite' ) ); ?>
            <?php
                wp_link_pages( array(
